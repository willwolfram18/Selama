    ...
    public class HomeController : _BaseAuthorizeController
    {
        ...
        public async Task<ActionResult> ForgotPassword(ForgotPasswordViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                var callbackUrl = Url.Action("ResetPassword", "Home", new { area = "Account", userId = user.Id, code = code }, protocol: Request.Url.Scheme);
                await UserManager.SendEmailAsync(user.Id, "Reset Password", "Please reset your password by clicking <a href=\"" + callbackUrl + "\">here</a>");
                // return RedirectToAction("ForgotPasswordConfirmation", "Home", new { area = "Account" });
            }
        ...
        public ActionResult ExternalLogin(string provider, string returnUrl)
        {
            ...
            return new ChallengeResult(provider, Url.Action("ExternalLoginCallback", "Home", new { area = "Account", ReturnUrl = returnUrl }));
        }
