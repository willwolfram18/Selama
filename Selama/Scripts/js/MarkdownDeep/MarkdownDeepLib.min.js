...
define("MarkdownDeepEditor", ["jquery"], function($)
{
    var jQuery = $;
    MarkdownDeep=new(function(){function S(b,e){if(b.indexOf!==undefined)return b.indexOf(e);for(var c=0;c<b.length;c++)
    ...
    // MarkdownDeep - http://www.toptensoftware.com/markdowndeep
    // Copyright (C) 2010-2011 Topten Software
    MarkdownDeepEditor=new(function(){var q=false,w={Z:"undo",Y:"redo",B:"bold",I:"italic",H:"heading",K:"code",U:
    ...
    // MarkdownDeep - http://www.toptensoftware.com/markdowndeep
    // Copyright (C) 2010-2011 Topten Software
    MarkdownDeepEditorUI=new(function(){this.HelpHtmlWritten=false;this.HelpHtml=function(b){var a="";a+=
        ...
        (f).height();$(document).bind("mousemove.mdd",e);$(document).bind("mouseup.mdd",g);return false;function g(b){$(document
            ...
            $(f).height(b);return false}};var j=0,i=false;this.onShowHelpPopup=function(){$("#mdd_syntax_container").fadeIn("fast");
                ...
                MarkdownDeep=function(f){var h={resizebar:true,toolbar:true,help_location:"mdd_help.html"};if(f)a.extend(h,f);
                    return this.each(function(xyz){var d=a(this).parent(".mdd_editor_wrap");if(d.length==0)d=a(this).wrap(
                    ...
                    HelpHtml(h.help_location));l.appendTo(a("body"));a("#mdd_close_help").click(MarkdownDeepEditorUI.onCloseHelpPopup);
                        ...
                        "data-mdd-preview");if(!j)j=".mdd_preview";var i=a(j)[xyz];if(!i){a('<div class="mdd_preview"></div>').insertAfter(b?b:
                        this);i=a(".mdd_preview")[xyz]}var g=new MarkdownDeepEditor.Editor(this,i);if(f){jQuery.extend(g.Markdown,f);jQuery.extend
